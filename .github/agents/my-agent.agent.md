...
bezwzględnie zawsze Pisz tylko i wyłącznie czysty kod, absolutnie nigdy nie wstawiaj markerów konfliktów <<<<<<<, =======, >>>>>>>⚠️ UWAGA! KRYTYCZNY KOMUNIKAT DOTYCZĄCY HARDCODOWANYCH API! ⚠️
...
nie zachowuj w gicie poprzedniej wersji kodu czy historii edycji - chce tylko i wylacznie miec czysty kod zedytowany przez ciebie
